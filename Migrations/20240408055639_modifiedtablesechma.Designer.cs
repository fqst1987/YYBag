...
namespace YYBagProgram.Migrations
{
    ...
    [Migration("20240408055639_modifiedtablesechma")]
    partial class modifiedtablesechma
    {
            ...
            modelBuilder.Entity("YYBagProgram.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("dateLastUpdateTime")
            ...
            modelBuilder.Entity("YYBagProgram.Models.ProductsColorDetail", b =>
                {
                    ...
                    b.Property<string>("strPictureURL")
                        .IsRequired()
                        .HasColumnType("varchar(max)");

                    b.HasKey("strColor", "ProductStatus");
